...
dependencies {
    ...
    modImplementation("net.fabricmc.fabric-api:fabric-message-api-v1:${properties["fabric_version"] as String}")
...
loom {
    accessWidenerPath = file("src/main/resources/addonbuu.accesswidener")
}
