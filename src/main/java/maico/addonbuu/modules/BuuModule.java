...
public class BuuModule extends Module {
     ...
     */
    public BuuModule() {
        super(AddonBuu.ADDONBUU, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link AddonBuu#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
